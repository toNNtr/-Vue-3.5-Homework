            ...
            <ul class="colors">
                <li class="colors__item">
                    <label class="colors__label" title="Очистить">
                        <input class="colors__radio sr-only" type="radio" name="color" value="null" v-model="currentColorID">
                        <span class="colors__value" style="background-image: url('/img/x-mark.png'); background-color: #fff; background-size: cover; background-repeat: no-repeat;">
                        </span>
                    </label>
                </li>
                <li class="colors__item"
